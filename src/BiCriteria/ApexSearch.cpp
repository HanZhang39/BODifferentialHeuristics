...
bool ApexSearch::is_dominated(ApexPathPairPtr ap){
    ...
    bool res =  solution_dom_checker->is_dominated(ap);
    return res;
}
...
void ApexSearch::operator()(size_t source, size_t target, Heuristic &heuristic, std::vector<ApexPathPairPtr> & solutions, unsigned int time_limit) {
    ...
    ApexPathSolutionSet& ap_solutions = solutions;
    ApexPathPairPtr   ap;
    ApexPathPairPtr   next_ap;
